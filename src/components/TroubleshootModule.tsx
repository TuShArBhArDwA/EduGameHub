...
export function TroubleshootModule({ language, userRole, isOffline }: TroubleshootModuleProps) {
  ...
  const translations = {
    ...
    pa: {
      ...
      runDiagnostic: 'ਡਾਇਗਨੌਸਟਿਕ ਚਲਾਓ',
      runningDiagnostic: 'ਡਾਇਗਨੌਸਟਿਕ ਚੱਲ ਰਿਹਾ ਹੈ...',
      category: 'ਸ਼੍ਰੇਣੀ',
      all: 'ਸਾਰੀਆਂ ਸਮੱਸਿਆਵਾਂ',
      network: 'ਨੈੱਟਵਰਕ ਸਮੱਸਿਆਵਾਂ',
      performance: 'ਪ੍ਰਦਰਸ਼ਨ ਦੀਆਂ ਸਮੱਸਿਆਵਾਂ',
      audio: 'ਆਡੀਓ ਸਮੱਸਿਆਵਾਂ',
      game: 'ਗੇਮ ਦੀਆਂ ਸਮੱਸਿਆਵਾਂ',
      login: 'ਲੌਗਇਨ ਸਮੱਸਿਆਵਾਂ',
      sync: 'ਸਿੰਕ ਦੀਆਂ ਸਮੱਸਿਆਵਾਂ',
      severity: 'ਗੰਭੀਰਤਾ',
      low: 'ਘੱਟ',
      medium: 'ਮੱਧਮ',
      high: 'ਉੱਚ',
      solution: 'ਹੱਲ',
      steps: 'ਠੀਕ ਕਰਨ ਦੇ ਕਦਮ',
      diagnosticComplete: 'ਡਾਇਗਨੌਸਟਿਕ ਪੂਰਾ ਹੋਇਆ',
      noIssuesFound: 'ਕੋਈ ਵੱਡੀ ਸਮੱਸਿਆ ਨਹੀਂ ਮਿਲੀ',
      offlineHelp: 'ਔਫਲਾਈਨ ਮਦਦ ਉਪਲਬਧ ਹੈ',
      contactSupport: 'ਸਹਾਇਤਾ ਨਾਲ ਸੰਪਰਕ ਕਰੋ',
      clearData: 'ਐਪ ਡਾਟਾ ਸਾਫ਼ ਕਰੋ',
      resetSettings: 'ਸੈਟਿੰਗਾਂ ਰੀਸੈਟ ਕਰੋ',
      downloadOfflineHelp: 'ਔਫਲਾਈਨ ਮਦਦ ਡਾਊਨਲੋਡ ਕਰੋ',
      
      slowLoading: 'ਐਪ ਹੌਲੀ ਲੋਡ ਹੋ ਰਹੀ ਹੈ',
      noInternet: 'ਕੋਈ ਇੰਟਰਨੈੱਟ ਕਨੈਕਸ਼ਨ ਨਹੀਂ',
      gameNotStarting: 'ਗੇਮ ਸ਼ੁਰੂ ਨਹੀਂ ਹੋ ਰਹੀ',
      audioNotWorking: 'ਆਡੀਓ ਕੰਮ ਨਹੀਂ ਕਰ ਰਿਹਾ',
      loginFailed: 'ਲੌਗਇਨ ਨਹੀਂ ਹੋ ਸਕਦਾ',
      dataNotSyncing: 'ਡਾਟਾ ਸਿੰਕ ਨਹੀਂ ਹੋ ਰਿਹਾ',
      gameFreesing: 'ਗੇਮ ਫ੍ਰੀਜ਼ ਹੋ ਰਹੀ ਹੈ',
      soundDelayed: 'ਆਵਾਜ਼ ਦੇਰੀ ਨਾਲ ਆ ਰਹੀ ਹੈ',
      
      slowLoadingSolution: 'ਲਾਈਟ ਮੋਡ ਚਾਲੂ ਕਰੋ ਅਤੇ ਕੈਸ਼ ਸਾਫ਼ ਕਰੋ',
      noInternetSolution: 'ਔਫਲਾਈਨ ਮੋਡ \'ਤੇ ਜਾਓ ਜਾਂ ਨੈੱਟਵਰਕ ਦੀ ਜਾਂਚ ਕਰੋ',
      gameNotStartingSolution: 'ਐਪ ਨੂੰ ਮੁੜ-ਚਾਲੂ ਕਰੋ ਅਤੇ ਡਿਵਾਈਸ ਸਟੋਰੇਜ ਦੀ ਜਾਂਚ ਕਰੋ',
      audioNotWorkingSolution: 'ਡਿਵਾਈਸ ਦੀ ਆਵਾਜ਼ ਅਤੇ ਐਪ ਦੀਆਂ ਇਜਾਜ਼ਤਾਂ ਦੀ ਜਾਂਚ ਕਰੋ',
      loginFailedSolution: 'ਕ੍ਰੈਡੈਂਸ਼ੀਅਲ ਦੀ ਪੁਸ਼ਟੀ ਕਰੋ ਅਤੇ ਨੈੱਟਵਰਕ ਕਨੈਕਸ਼ਨ ਦੀ ਜਾਂਚ ਕਰੋ',
      dataNotSyncingSolution: 'ਇੰਟਰਨੈੱਟ ਕਨੈਕਸ਼ਨ ਦੀ ਜਾਂਚ ਕਰੋ ਅਤੇ ਸਿੰਕ ਕਰਨ ਦੀ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ',
      gameFreezingSolution: 'ਦੂਜੀਆਂ ਐਪਾਂ ਬੰਦ ਕਰੋ ਅਤੇ ਲਾਈਟ ਮੋਡ ਚਾਲੂ ਕਰੋ',
      soundDelayedSolution: 'ਐਪ ਨੂੰ ਮੁੜ-ਚਾਲੂ ਕਰੋ ਅਤੇ ਆਡੀਓ ਸੈਟਿੰਗਾਂ ਦੀ ਜਾਂਚ ਕਰੋ'
    }
  };

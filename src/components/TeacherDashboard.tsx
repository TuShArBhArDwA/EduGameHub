...
export function TeacherDashboard({ user, language, isOffline, isLiteMode, onLiteModeToggle }: TeacherDashboardProps) {
  ...
  const translations = {
    ...
    pa: {
      sandbox: 'ਸੈਂਡਬੌਕਸ ਮਾਡਿਊਲ',
      analytics: 'ਵਿਦਿਆਰਥੀ ਵਿਸ਼ਲੇਸ਼ਣ',
      content: 'ਸਮੱਗਰੀ ਪ੍ਰਬੰਧਨ',
      classes: 'ਮੇਰੀਆਂ ਜਮਾਤਾਂ',
      createGame: 'ਨਵੀਂ ਗੇਮ ਬਣਾਓ',
      uploadContent: 'ਸਮੱਗਰੀ ਅੱਪਲੋਡ ਕਰੋ',
      aiConverter: 'AI ਗੇਮ ਕਨਵਰਟਰ',
      templates: 'ਗੇਮ ਟੈਂਪਲੇਟਸ',
      activeStudents: 'ਸਰਗਰਮ ਵਿਦਿਆਰਥੀ',
      completedGames: 'ਪੂਰੀਆਂ ਹੋਈਆਂ ਗੇਮਾਂ',
      avgScore: 'ਔਸਤ ਸਕੋਰ',
      engagement: 'ਭਾਗੀਦਾਰੀ ਦਰ',
      class: 'ਜਮਾਤ',
      students: 'ਵਿਦਿਆਰਥੀ',
      progress: 'ਪ੍ਰਗਤੀ',

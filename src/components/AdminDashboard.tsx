...
export function AdminDashboard({ user, language, isOffline, isLiteMode, onLiteModeToggle }: AdminDashboardProps) {
  ...
  const translations = {
    ...
    pa: {
      overview: 'ਸਿਸਟਮ ਓਵਰਵਿਊ',
      users: 'ਯੂਜ਼ਰ ਪ੍ਰਬੰਧਨ',
      content: 'ਸਮੱਗਰੀ ਪ੍ਰਬੰਧਨ',
      updates: 'ਅੱਪਡੇਟ ਪ੍ਰਬੰਧਨ',
      troubleshoot: 'ਸਮੱਸਿਆ-ਨਿਵਾਰਨ ਕੇਂਦਰ',
      totalUsers: 'ਕੁੱਲ ਯੂਜ਼ਰ',
      activeUsers: 'ਸਰਗਰਮ ਯੂਜ਼ਰ',
      systemHealth: 'ਸਿਸਟਮ ਦੀ ਸਿਹਤ',
      storageUsed: 'ਵਰਤੀ ਗਈ ਸਟੋਰੇਜ',
      cpuUsage: 'CPU ਦੀ ਵਰਤੋਂ',
      memoryUsage: 'ਮੈਮੋਰੀ ਦੀ ਵਰਤੋਂ',
      networkStatus: 'ਨੈੱਟਵਰਕ ਸਥਿਤੀ',
      lastUpdate: 'ਆਖਰੀ ਅੱਪਡੇਟ',
      pendingUpdates: 'ਬਕਾਇਆ ਅੱਪਡੇਟ',
      systemAlerts: 'ਸਿਸਟਮ ਚੇਤਾਵਨੀਆਂ',
      userGrowth: 'ਯੂਜ਼ਰ ਵਾਧਾ',
      contentLibrary: 'ਸਮੱਗਰੀ ਲਾਇਬ੍ਰੇਰੀ',
      addUser: 'ਨਵਾਂ ਯੂਜ਼ਰ ਸ਼ਾਮਲ ਕਰੋ',
      managePermissions: 'ਇਜਾਜ਼ਤਾਂ ਦਾ ਪ੍ਰਬੰਧਨ ਕਰੋ',
